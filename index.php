                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Calculo Sobreaviso</h1>
                            <div class="description">
                            	<p>
	                            	Faça login para fazer o calculo baseado na CLT de sobreaviso.
                            	</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Faça seu login no site</h3>
                            		<p>Entre com seu login e senha para ter acesso a sua conta:</p>
                        		</div>
